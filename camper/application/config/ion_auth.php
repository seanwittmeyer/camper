 ...
 */
$config['site_title']                 = "Zilifone Camper";       // Site Title, example.com
...
$config['maximum_login_attempts']     = 8;                   // The maximum number of failed login attempts.
$config['lockout_time']               = 30;                 // The number of seconds to lockout an account due to exceeded attempts
$config['forgot_password_expiration'] = 400000;              // The number of miliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
