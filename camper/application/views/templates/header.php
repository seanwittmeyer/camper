...
<body class="new <?php echo ($scope == 'admin') ? 'teal': 'blue'; ?>">
	<!--[if lt IE 7]>
	...
	<![endif]-->
	<header class="primary <?php echo ($scope == 'admin') ? 'teal': 'blue'; ?>">
		<div class="container">
			<div class="left">
			...
			<div class="right">
				<nav class="session">
					...
					<li><a href="<?php echo $baseurl; ?>me" class="">Your Account</a></li>
					<li><a href="<?php echo $baseurl; ?>me" class="">Welcome back <?php echo $user->first_name; ?>!</a></li>
