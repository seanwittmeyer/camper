...
<body class="blue">
	...
	<header class="blue">
		<div class="container">
			...
			<div class="right">
				<nav class="session">
					...
					<?php if ($this->ion_auth->in_group('staff')) { ?><li><a href="<?php echo base_url('atcamp'); ?>" class="">Staff</a></li><?php } ?>
					...
					<li><a href="<?php echo $this->config->item('camper_councilpublicsite'); ?>" target="_blank" class="">Return to Camps Website</a></li>
		...
		<div class="container">
			...
			<div class="right">
				<nav class="main">
					<?php if($hasunit) : ?><!--<li><a href="<?php echo $baseurl; ?>resources" class="<?php if($section == 'resources') { ?> active<?php } ?>"><i class="campimg-book c<?php if($section == 'resources') { echo 'page'; } else { echo 'brown';} ?> tabicon"></i><br />Resources</a></li>-->
					...
					<li><a href="<?php echo $baseurl; ?>registrations" class="<?php if($section == 'register') { ?> active<?php } ?>"><i class="campimg-page c<?php if($section == 'register') { echo 'page'; } else { echo 'brown';} ?> tabicon"></i><br />Registrations</a></li>
					<li><a href="<?php echo $baseurl; ?>events" class="<?php if($section == 'events') { ?> active<?php } ?>"><i class="campimg-cal c<?php if($section == 'events') { echo 'page'; } else { echo 'brown';} ?> tabicon"></i><br />Events</a></li>
					<?php if(!$isindividual) : ?><li><a href="<?php echo $baseurl; ?>unit" class="<?php if($section == 'myunit') { ?> active<?php } ?>"><i class="campimg-scout c<?php if($section == 'myunit') { echo 'page'; } else { echo 'brown';} ?> tabicon"></i><br />My Unit</a></li><?php endif; ?>
					<?php else : ?><li><a href="<?php echo $baseurl; ?>me" class="<?php if($section == 'account') { ?> active<?php } ?>"><i class="campimg-scout c<?php if($section == 'account') { echo 'page'; } else { echo 'brown';} ?> tabicon"></i><br />My Account</a></li><?php endif; ?>
				</nav>
			</div>		
		</div>
	</header>
