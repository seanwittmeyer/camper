...
<table width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td>
            <b><h2 style="color: #30261B;margin-bottom:0px">Hi <?php echo $user->first_name; ?>, One More Step...</h2></b>
        </td>
    </tr>
    <tr>
    </tr>
...
<table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" style="max-width: 600px;">
    <tr>
        <td>
            ...
            <p>We need you to confirm your email address so we know can receive email updates regarding your unit's event and camp registrations. Simply hit <?php echo anchor('auth/activate/'. $id .'/'. $activation, 'activate' ); ?> and you'll be ready to sign in and register for camp and other events.</p>
            <p>Thanks!<br /><?php echo $this->config->item('camper_council'); ?></p>
        </td>
    </tr>
    <tr>
        <td class="templateButton" style="text-align: center; padding: 30px 0;">
            <?php echo anchor('auth/activate/'. $id .'/'. $activation, 'Activate &rarr;', 'style="font-size: 16px; color: #ffffff; background-color: #2284CC; padding: 15px 30px; border-radius: 5px; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-bottom: 0px solid #cc6b5e;" target="_blank"' ); ?>
        </td>
    </tr>
    <tr>
        <td>
        	<p>Don't see the link? Paste this link in your browser:<pre><?php echo site_url('auth/activate/'. $id .'/'. $activation); ?></pre></p>
        </td>
    </tr>
</table>
<!--[if (gte mso 9)|(IE)]>
                                        ...
                                        <table class="footerContent" width="100%" align="left" border="0" cellpadding="0" cellspacing="0" style="max-width: 600px;" bgcolor="#d8d7d5">
                                            <tr>
                                                <td style="padding: 15px;">
                                                    ...
                                                    We sent you this message because you just signed up for Camper, <?php echo $this->config->item('camper_council'); ?>'s registration system. Need additional help? Visit our <a style="color: #6e6473 !important; text-decoration: underline;" href="<?php echo $this->config->item('camper_protocol').$this->config->item('camper_domain'); ?>help">Help Center</a> or contact us at
