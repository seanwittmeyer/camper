...
<table width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td>
            <b><h2 style="color: #30261B;margin-bottom:0px">Reset your password</h2></b>
        </td>
    </tr>
    <tr>
    </tr>
...
<table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" style="max-width: 600px;">
    <tr>
        <td>
            ...
            <p>You have requested to reset your password. Simply hit the reset password button and you will be able to set a new password. Didn't want to reset your password? Just ignore this email.</p>
    ...
    <tr>
        <td class="templateButton" style="text-align: center; padding: 30px 0;">
            <?php echo anchor('auth/reset_password/'. $forgotten_password_code, 'Set a new password &rarr;', 'style="font-size: 16px; color: #ffffff; background-color: #2284CC; padding: 15px 30px; border-radius: 5px; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-bottom: 0px solid #cc6b5e;" target="_blank"'); ?>
        </td>
    </tr>
    <tr>
        <td>
        	<p>Don't see the link? Paste this link in your browser:<pre><?php echo site_url('auth/reset_password/'. $forgotten_password_code); ?></pre></p>
        </td>
    </tr>
</table>
<!--[if (gte mso 9)|(IE)]>
                                        ...
                                        <table class="footerContent" width="100%" align="left" border="0" cellpadding="0" cellspacing="0" style="max-width: 600px;" bgcolor="#d8d7d5">
                                            <tr>
                                                <td style="padding: 15px;">
                                                    ...
                                                    We sent you this message because you, or someone using your email, requested a new password for Camper, <?php echo $this->config->item('camper_council'); ?>'s registration system. Need additional help? Visit our <a style="color: #6e6473 !important; text-decoration: underline;" href="<?php echo $this->config->item('camper_protocol').$this->config->item('camper_domain'); ?>help">Help Center</a> or contact us at
