                    ...
                    <tr>
                        <td class="bodyContent" valign="top" style="border-collapse: collapse; background-color: #EFEBD2; padding: 15px 60px; color: #30261B;">
                            <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <h2 style="color: #30261B;margin-bottom:0px"><b>Feedback from Camper</b></h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
							            <p><?php if (!$this->ion_auth->logged_in()) { echo 'Someone'; } else { $singleuser = $this->ion_auth->user()->row(); echo '<a href="mailto:'.$singleuser->email.'">'.$singleuser->first_name.' '.$singleuser->last_name.'</a>'; } ?> was browsing <strong><a href="<?php echo $this->config->item('camper_protocol').$this->config->item('camper_domain').$this->config->item('camper_path').$uri; ?>"><?php echo $uri; ?></a></strong> and was <strong>"<?php echo $doing; ?>"</strong>. What when wrong was <strong>"<?php echo $wrong; ?>"</strong>.</p>
							            <p>We have attached the server request details to help you get to the bottom of this. </p>
                                ...
                                <tr>
							        <td class="templateButton" style="text-align: center; padding: 30px 0;">
							            <a style="font-size: 16px; color: #ffffff; background-color: #2284CC; padding: 15px 30px; border-radius: 5px; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-bottom: 0px solid #cc6b5e;" target="_blank" href="<?php echo base_url(); ?>">Sign in &rarr;</a>
							        </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    <td style="padding: 15px;">
                                        ...
                                        <p style="font-size: 12px; line-height: 16px;">
                                        	We sent you this message because you are an administrator for Camper, <?php echo $this->config->item('camper_council'); ?>'s registration system. Need additional help? Visit our <a style="color: #6e6473 !important; text-decoration: underline;" href="<?php echo $this->config->item('camper_protocol').$this->config->item('camper_domain'); ?>help">Help Center</a> or contact us at
