                        ...
                        <table class="twelve columns">
                          <tr>
                            <td class="six sub-columns">
                              <img src="http://dev.camperapp.org/camper.small.png">
                            </td>
                            <td class="six sub-columns last" style="text-align:right; vertical-align:middle;">
                              <span class="template-label">Camper Registration System</span>
                            </td>
                    ...
                    <td class="wrapper last">
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td>
                            <h2>Hi, Sean</h2>
                			<p>We received some feedback from someone on Camper.</p>
                			<p>Someone was browsing <strong><?php echo $uri; ?></strong> and was <strong>"<?php echo $doing; ?>"</strong>. What when wrong was <strong>"<?php echo $wrong; ?>"</strong>.</p>
                			<p>That is all we know.</p>
                			<p>Cheers,<br />Camper</p>
                          </td>
                    ...
                    <td class="wrapper last">
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td class="panel">
                            <h3>Details</h3>
                            <pre class="block-grid"><?php print_r(array($_SERVER,$_REQUEST)); ?></pre>
                          </td>
                          <td class="expander"></td>
                        </tr>
                      </table>
                    ...
                    <td class="wrapper last">
                      ...
                      <table class="twelve columns">
                        <tr>
                          <td align="center">
                            <center>
                              <p style="text-align:center;">You got this message because you are set up as an administrator on Camper.</p>
                              <p style="text-align:center;"><a href="http://camperapp.org/camper/me">Stop these messages</a></p>
                            </center>
                          </td>
                          <td class="expander"></td>
                        </tr>
