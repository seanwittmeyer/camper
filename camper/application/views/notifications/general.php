                    ...
                    <tr>
                        <td class="bodyContent" valign="top" style="border-collapse: collapse; background-color: #EFEBD2; padding: 15px 60px; color: #30261B;">
                            <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <h2 style="color: #30261B;margin-bottom:0px"><b>Hi <?php echo $tofirst; ?></b></h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
							        <td class="templateButton" style="text-align: center; padding: 30px 0;">
							            <a style="font-size: 16px; color: #ffffff; background-color: #2284CC; padding: 15px 30px; border-radius: 5px; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-bottom: 0px solid #cc6b5e;" target="_blank" href="<?php echo $link; ?>">View on <?php echo $this->config->item('camper_fromname') ?> &rarr;</a>
							        </td>
                                </tr>
                            </table>
                        </td>
