...
<html>
    ...
    <body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="width: 100% !important; -webkit-text-size-adjust: none; color: #5b5b5b; margin-top: 0; margin-right: 0; margin-bottom: 0; margin-left: 0; padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0; font-style: normal; font-variant: normal; font-weight: normal; font-size: 15px; line-height: 24px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #d8d7d5;" bgcolor="#d8d7d5">
        <center>Can't read this email? <a href="<?php echo base_url('/email/'.$token); ?>">Click here to view it online</a>.</center>
...
<table width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td>
            <b><h2 style="color: #30261B;margin-bottom:0px"><?php echo $message['title']; ?></h2></b>
        </td>
    </tr>
    <tr>
    </tr>
...
<table width="100%" align="left" border="0" cellpadding="0" cellspacing="0" style="max-width: 600px;">
    ...
    <tr>
        <td class="templateButton" style="text-align: center; padding: 30px 0;">
            <a style="font-size: 16px; color: #ffffff; background-color: #2284CC; padding: 15px 30px; border-radius: 5px; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-bottom: 0px solid #cc6b5e;" target="_blank" href="<?php echo ($message['link']) ? base_url($message['link']): base_url(); ?>">View on <?php echo $this->config->item('camper_fromname') ?> &rarr;</a>
        </td>
    </tr>
</table>
<!--[if (gte mso 9)|(IE)]>
                                        ...
                                        <table class="footerContent" width="100%" align="left" border="0" cellpadding="0" cellspacing="0" style="max-width: 600px;" bgcolor="#d8d7d5">
                                            <tr>
                                                <td style="padding: 15px;">
                                                    ...
                                                    <?php echo ($message['youareregistered']) ? $message['youareregistered']: 'You recieved this message because you are a contact for your unit on Camper, our camps registration system'; ?>. Need additional help? Visit our <a style="color: #6e6473 !important; text-decoration: underline;" href="<?php echo $this->config->item('camper_protocol').$this->config->item('camper_domain'); ?>help">Help Center</a> or contact us at
