                    ...
                    <tr>
                        <td class="bodyContent" valign="top" style="border-collapse: collapse; background-color: #EFEBD2; padding: 15px 60px; color: #30261B;">
                            <table width="100%" align="left" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <h2 style="color: #30261B;margin-bottom:0px"><b>Manage <?php echo $data['unit']; ?> on Camper</b></h2>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    	<p><strong><?php echo $data['source']; ?></strong> from <strong><?php echo $data['sourcefrom']; ?></strong> has invited you to be <?php echo $data['unit']; ?>'s alternate contact on Camper, Longs Peak Council's online registration system. Camper is the one stop place to manage <?php echo $data['unit']; ?>'s registration for council and district events from camporees to trainings, from summer camp to weekend outings.</p></p>
										<p>Yours in Scouting,<br /><?php echo $data['source']; ?> (via Camper)</p>
									</td>
                                </tr>

                                <tr>
                                    <td class="templateButton" style="text-align: center; padding: 30px 0;"><?php echo anchor("start/invite/".$token, 'Finish signup &rarr;', 'style="font-size: 16px; color: #ffffff; background-color: #2284CC; padding: 15px 30px; border-radius: 5px; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-bottom: 0px solid #cc6b5e;" target="_blank"');?></td>
                                </tr>
                                <tr>
	                                <td><p style="text-align: center; font-size: 11px;">Don't see the link? Paste this link in your browser:<pre><?php echo site_url("start/invite/".$token); ?></pre></p></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                            ...
                            <table class="footerContent" width="100%" align="left" border="0" cellpadding="0" cellspacing="0" style="width: 100%; max-width: 600px;" bgcolor="#D8D7D5">
                                <tr>
                                    <td style="padding: 15px;">
                                        ...
                                        We sent you this message because you were invited by <?php echo $data['source']; ?></strong> to manage <?php echo $data['sourcefrom']; ?> on Camper, <?php echo $this->config->item('camper_council'); ?>'s registration system. Need additional help? Visit our <a style="color: #6e6473 !important; text-decoration: underline;" href="<?php echo $this->config->item('camper_protocol').$this->config->item('camper_domain'); ?>help">Help Center</a> or contact us at
