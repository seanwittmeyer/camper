...
?>	<div class="subnav">
	...
	<?php echo form_open(uri_string());?>
		...
		<div class="container">
			<div class="quarter">
				<h2>Unit Members</h2>
				<p>Manage your unit's primary and alternate contacts, your members, and other details here. Didn't want to add a new member, you can <?php echo anchor('unit/members', 'see all members'); ?>.</p>
				<p><?php echo anchor('unit/members', '&larr; All Members', 'class="btn tan"'); ?> <?php echo anchor('unit/members/new', 'New', 'class="btn teal"'); ?></p>	
				<div class="clear"></div>
			</div>
			<div class="threequarter">
				...
				<div class="clear"></div>
				<p><input type="submit" name="submit" value="Save Changes" class="btn teal" data-loading-text="Saving changes..." onclick="$(this).button('loading');" /> <input type="reset" name="reset" value="Reset" class="btn tan"  /> <span class="right"><?php echo anchor('unit/members/'.$member['id'].'/delete', 'Delete '.$member['name'], 'class="btn red camperhoverpopover" data-toggle="popover" title="Delete '.$member['name'].'" data-placement="top" data-content="Are you sure you want to delete '.$member['name'].'? <br /><br />When you delete '.$member['name'].', all event roster and activity registrations will also be removed."'); ?></span></p>
