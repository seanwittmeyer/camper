...
?>	<div class="subnav">
	...
	<?php echo form_open(uri_string());?>
		...
		<div class="container">
			<div class="quarter">
				<h2>Unit Members</h2>
				<p>Manage your unit's primary and alternate contacts and other details here. Didn't want to add a new member, you can <?php echo anchor('unit/members', 'see all members'); ?>.</p>
				<p><?php echo anchor('unit/members', '&larr; All Members', 'class="btn tan"'); ?> </p>	
				<div class="clear"></div>
			</div>
			<div class="threequarter">
				...
				<div class="camperform float " style="width: 70%"><input type="text" name="member[name]" id="fname" value="<?php echo ($success) ? '': set_value('member[name]'); ?>" placeholder="Baden Powell" data-toggle="tooltip" title="The member's name" /><label for="fname">Full Name</label></div>
				<div class="clear"></div>
				...
				<div class="camperform float camperhoverpopover" style="width: 30%" placeholder="Click to set..." data-toggle="tooltip" data-content="We use the date of birth to calculate the age of a participant at the time of an event."><input type="text" name="member[dob]" class="datepicker" placeholder="Click to set..." id="fdob" value="<?php echo ($success) ? '': set_value('member[dob]'); ?>"  /><label for="fdob">Date of Birth</label></div>
				<div class="clear"></div>
